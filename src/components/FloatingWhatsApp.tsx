...
export const FloatingWhatsApp: React.FC = () => {
  return (
    <a
      ...
      className="fixed bottom-4 left-4 sm:bottom-6 sm:left-6 z-40 bg-emerald-500 hover:bg-emerald-400 text-zinc-950 p-3 sm:p-3.5 rounded-full shadow-2xl transition-all transform hover:scale-110 active:scale-95 flex items-center gap-2 group border-2 border-emerald-300"
